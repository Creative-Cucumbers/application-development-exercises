...
| 時間 | 内容 | 種別 | リモート対応 |
| --- | --- | --- | --- |
| 0〜10分 | アイスブレイク・今日の概要・Day3 からの橋渡し | 全体参加 | Slack 参加 |
| 10〜15分 | 最近のニュース | 講義 | 視聴・チャット |
| 15〜30分 | コーディングエージェントとは・種類の比較 | 講義 | 視聴・チャット |
| 30〜45分 | セットアップ確認（VSCode / Git / Gemini CLI） | 実習 | 同様に実施・詰まったら Slack で質問 |
| 42〜55分 | Gemini CLI 入門：基本操作を一緒に試す | 講義＋実習 | 視聴・同様に実施 |
| 55〜65分 | Git in VSCode：init → ステージング → コミット | 講義＋実習 | 同様に実施 |
| 65〜80分 | **Git 演習：hello.html → コミット → 変更 → 元に戻す** | 実習 | 同様に実施 |
| 80〜95分 | バイブコーディング：投票アプリ（HTML/JS）を作る | 実習 | 同様に実施 |
| 95〜100分 | 「消えた」問題の確認・問いかけ | 実習＋問いかけ | 視聴・Slack 参加 |

### 2コマ目（100分）

| 時間 | 内容 | 種別 | リモート対応 |
| --- | --- | --- | --- |
| 0〜20分 | なぜデータが重要か | 講義＋問いかけ | 視聴・チャット |
| 20〜50分 | データの種類（構造化・非構造化・AI による変化）+ JSON を書く | 講義＋実習 | 同様に実施 |
| 50〜60分 | データベースとは何か（SQLite の位置づけ） | 講義 | 視聴・チャット |
| 60〜90分 | SQLite 実践（sqliteonline.com） | 実習 | ブラウザで同様に実施 |
| 90〜100分 | まとめ・Day5 予告 | 講義 | 参加可 |
